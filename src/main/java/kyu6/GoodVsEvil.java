 ...
 * All values are non-negative integers. The resulting sum of the worth for each side will
 * not exceed the limit of a 32-bit integer.
 * Output:
 * Return "Battle Result: Good triumphs over Evil" if good wins,
 * "Battle Result: Evil eradicates all trace of Good" if evil wins, or "Battle Result: No victor on this
 * battlefield" if it ends in a tie.
 */
